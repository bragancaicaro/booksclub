...
class TalkSearchListWidget extends StatefulWidget {
  final TalksSearchManager talksManager;
  final String itemId;
  final String urlTalks;
  final ScrollController scrollController;
  const TalkSearchListWidget({
  ...
  @override
  _TalkSearchListWidgetState createState() => _TalkSearchListWidgetState();
}

class _TalkSearchListWidgetState extends State<TalkSearchListWidget> with AutomaticKeepAliveClientMixin {
  int _currentPage = 0;
  ...
  Widget build(BuildContext context) {
    ...
    if(widget.talksManager.items.isEmpty){
      return Padding(
        ...
        child: Center(
        child: Text(
          AppLocalizations.of(context).search_talk,
