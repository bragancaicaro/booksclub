...
class TalkCommentListWidget extends StatefulWidget {
  final TalksManager talksManager;
  final String itemId;
  final String urlTalks;
  final ScrollController scrollController;
  const TalkCommentListWidget({
  ...
  @override
  _TalkCommentListWidgetState createState() => _TalkCommentListWidgetState();
}

class _TalkCommentListWidgetState extends State<TalkCommentListWidget> with AutomaticKeepAliveClientMixin {
  int _currentPage = 0;
